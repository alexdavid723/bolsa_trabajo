    ...
    <h1 class="mt-5">Editar Usuario</h1>
        <form action="actualizar_usuario.php" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="txt_nombres" name="txt_nombres" value="<?php echo $usuario['nombre']; ?>">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="txt_direccion" name="txt_direccion" value="<?php echo $usuario['dirección']; ?>">
            </div>
            <div class="form-group">
                <label for="txt_telefono">Teléfono:</label>
                <input type="text" class="form-control" id="txt_telefono" name="txt_telefono" value="<?php echo $usuario['teléfono']; ?>">
            </div>
